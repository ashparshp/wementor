...
export default function LoginPage() {
  ...
  return (
    <div className="flex-grow flex items-center justify-center min-h-[calc(100vh-5rem)] py-8 px-4 sm:px-6 relative overflow-hidden">
        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input id="remember-me" type="checkbox" className="h-4 w-4 text-[#F29440] focus:ring-[#F29440] border-gray-300 rounded" />
