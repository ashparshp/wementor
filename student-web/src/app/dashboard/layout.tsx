...
export default function DashboardLayout({
  ...
  return (
    <div className="flex-grow bg-[#FEF1E3] flex flex-col md:flex-row min-h-[calc(100vh-0px)]">
      {/* Mobile Topbar */}
      <div className="md:hidden sticky top-0 left-0 right-0 z-[60] bg-[#FFF8F1] border-b border-[#EADBCB]">
          ...
          <button
            ...
            className={`p-2 -mr-2 rounded-lg transition-colors ${
              isMobileMenuOpen
                ...
                : "text-[#A08D7C] hover:text-[#EA8A2F] hover:bg-black/5"
            }`}
        ...
        {/* Mobile dropdown — expands below topbar */}
        <div
          className={`overflow-hidden transition-[max-height,opacity] duration-300 ease-out ${
            isMobileMenuOpen ? "max-h-[calc(100dvh-3.5rem)] opacity-100" : "max-h-0 opacity-0"
          }`}
          aria-hidden={!isMobileMenuOpen}
        >
          <div
            data-scroll-lock-ignore
            className="border-t border-[#EADBCB] bg-[#FFF8F1] px-3 py-3 space-y-1 max-h-[calc(100dvh-3.5rem)] overflow-y-auto overscroll-contain"
          >
            {navItems.map((item) => {
            ...
            <div className="pt-3 mt-2 border-t border-[#EADBCB]">
              <div className="mb-3 px-2 flex items-center gap-3">
                <div className="h-9 w-9 rounded-full bg-[#EA8A2F]/10 flex items-center justify-center text-[#EA8A2F] font-bold shrink-0">
      ...
      {/* Main Content Area */}
      <div className="flex-grow overflow-x-hidden overflow-y-auto p-4 sm:p-6 md:p-8">
