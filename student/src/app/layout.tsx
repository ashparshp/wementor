      ...
      <body className={`${spaceGrotesk.className} antialiased bg-gray-50/50 min-h-screen flex flex-col`}>
        ...
        <footer className="bg-white border-t border-gray-100 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Image src="/logo-hor-no-bg.png" alt="Logo" width={240} height={80} className="h-12 w-auto mx-auto mb-6 object-contain opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all" />
