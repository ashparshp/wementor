        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="pt-2 space-y-4">
            <button
              ...
              className="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-[0_10px_25px_rgba(17,24,39,0.18)] text-sm font-bold text-[#FFFFFF] bg-[#111827] hover:bg-[#1F2937] focus:outline-none transition-all active:scale-[0.98] disabled:opacity-70 disabled:scale-100"
            >
